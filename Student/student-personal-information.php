...
<?php
	...
	if (isset($_POST['sub'])) {
		...
		$query="update student_info set first_name='$first_name',middle_name='$middle_name',last_name='$last_name',father_name='$father_name',mobile_no='$mobile_no',gender='$gender',semester='$semester',total_marks='$total_marks',obtain_marks='$obtain_marks',current_address='$current_address',permanent_address='$permanent_address',state='$state',place_of_birth='$place_of_birth' where email='$roll_no'";
