...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2022 at 05:55 PM
...
INSERT INTO `login` (`ID`, `name`, `user_id`, `Password`, `Role`, `account`) VALUES
(2, 'Admin', 'admin@gmail.com', 'admin123*', 'Admin', 'Activate'),
(5, 'Staff 1', 'staff1@gmail.com', 'teacher123*', 'Teacher', 'Activate'),
(6, 'Staff 2', 'staff2@gmail.com', 'teacher123*', 'Teacher', 'Deactivate'),
(21, 'for admission', 'admission@gmail.com', 'teacher123*', 'Teacher', 'Deactivate'),
(23, 'Student', 'student@gmail.com', 'student123*', 'Student', 'Activate'),
(28, 'nihar', 'nihar@gmail.com', 'nihar123*', 'Student', 'Activate'),
(30, 'thakrar', 'francy@gmail.com', 'student123*', 'Student', ''),
(31, '', '', 'francy123*', 'Student', ''),
(32, 'thakrar', 'francy@gmail.com', 'student123*', 'Student', '');
...
--
-- Table structure for table `question_answer_files`
--

CREATE TABLE `question_answer_files` (
  `id` int(255) NOT NULL,
...
--
-- Dumping data for table `question_answer_files`
--

INSERT INTO `question_answer_files` (`id`, `file_name`, `year`, `course_code`) VALUES
(1, '3.jfif', 1, 'Programming'),
(6, '6.jpg', 2, 'Object'),
(7, '6.jpg', 2, 'Object'),
(8, '4.jpg', 3, 'MCS'),
(9, '4.jpg', 3, 'MCS'),
...
(7, 'MCS', 5, '5', 'DBMS', '', '19-05-22'),
(8, 'MCS', 1, '5', 'CSPD', '', '19-05-22'),
(9, 'MCS', 2, '5', 'DBMS', '', '19-05-22'),
(10, 'MCS', 2, '5', 'DLD', '', '19-05-22'),
(11, 'MCS', 1, '5', 'Ds', '', '19-05-22'),
(12, 'MCS', 1, '5', 'I2C', '', '19-05-22'),
(13, 'MCS', 2, '5', 'OOP', '', '19-05-22'),
(14, 'MCS', 2, '5', 'SE', '', '19-05-22'),
(15, 'MCS', 2, '5', 'WEB', '', '19-05-22');
...
(3, '123', 1000, '2022-09-15 18:22:05', 'Paid'),
(5, '5', 45000, '2022-09-15 18:37:34', 'Paid');
...
('', 'Francy', 'thakrar', 'vipulbhai', 'vipulbhai', 'francy@gmail.com', '7986546210', 'BBA', 'S19', '', 'No', 'Yes', '', 'Admitted', 'Approved', '', '2022-08-29', '', 'Female', 'Plot No 34, Faridabad, Faridabad, Delhi', 'Plot No 34, Faridabad, Faridabad, Delhi', 'Delhi', '', '', '', '', '', '', '', '', '', 1, 0, 0, '', '2022-09-20 15:52:36'),
('123', 'darshan', 'pravinkumar', 'khant', 'pravinkumar', 'darshan@gmail.com', '1234568970', 'BBA', 'S19', '3.jfif', 'No', 'No', '', 'Admitted', 'Approved', '', '2022-09-13', '', 'Male', '24, T S P Road, Kalasipalyam, Bangalore, Karnataka, 560002', '24, T S P Road, Kalasipalyam, Bangalore, Karnataka, 560002', 'Karnataka', '', '', '', '', '', '', '', '', '', 5, 0, 0, 'Delhi', '2022-09-20 14:50:12'),
('123456', 'joshi', 'nihar', 'kumar', 'HarshadBhai', 'nihar@gmail.com', '78945611230', 'BBA', 'S19', '', 'No', 'No', '', 'Admitted', 'Approved', '', '2022-09-01', '', 'Male', '8,', '8,', 'Karnataka', '', '', '', '', '', '', '', '', '', 1, 0, 0, 'Banglore', '2022-09-20 14:57:19');
...
(3, 'Teacher', 'Teacher', 'Teacher', '', 'tesla@gmail.com', '7894561230', 0x342e6a7067, 'Permanent', 'Yes', 'asa745', '2000-01-01', 1237894560, 'Male', 'asdfghjkl', 'qwerty', 'zxcvbnm', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '19-05-22'),
(4, 'admission', 'testing', 'last admission', '', 'admission@gmail.com', '1234567890', 0x6c6f676f2d4449542e706e67, 'Permanent', 'Yes', '', '2022-09-01', 0, 'Male', '1234, fsdasdff', 'asdfghjkl', 'asadadada', '2022-09-02', '2022-09-02', '1.jpg', '2022-09-03', '2022-09-03', '2.jpg', '2022-09-04', '2022-09-04', '3.jpg', '2022-09-05', '2022-09-05', '4.jpg', '', '', '14-09-22');
...
(31, 1234567890, 2147483647, 'Paid', '2022-05-19 11:20:16'),
(32, 1234567890, 2147483647, 'Paid', '2022-05-19 11:20:59');
...
(7, '1234567890', 5, '16:01', '17:01', '1', 'asdfg', 412),
(8, 'MCS', 1, '13:00', '14:00', '2', 'CSPD', 410);
...
--
-- Indexes for table `question_answer_files`
--
ALTER TABLE `question_answer_files`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `question_answer_files`
--
ALTER TABLE `question_answer_files`
...
--
ALTER TABLE `student_courses`
  MODIFY `student_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
