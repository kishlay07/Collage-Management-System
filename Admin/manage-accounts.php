...
if (isset($_POST['submit'])) {
	...
	if ($account == "Select Account Status") {
		echo "Please Select Account Status.";
	}else{
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="exampleInputEmail1">Select User Id:</label>
												<select class="browser-default custom-select" name="user_id">
													<option >Select UserId</option>
													<?php
													$query="select name, user_id from login WHERE Role != 'Admin'";
