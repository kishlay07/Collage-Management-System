...
<html lang="en">
	...
	while ($row=mysqli_fetch_array($run)) {
		...
		<div class="container  mt-1 border border-secondary mb-1">
			<div class="row text-black bg-grey pt-5">
				<div class="col-md-4">
					<?php  $profile_image= $row["profile_image"] ?>
					<?php 
					if (empty($profile_image)) {?>
						<img class="ml-5 mb-5" height='290px' width='250px' src=<?php echo "images/logo-DIT.png"  ?> >
					<?php } else { ?>
						<img class="ml-5 mb-5" height='290px' width='250px' src=<?php echo "images/$profile_image"  ?> >
					<?php } ?>
				</div>
				<div class="col-md-8">
					<!-- <a style="color: black;" class="text-black"><?php echo $row['first_name']." ".$row['middle_name']." ".$row['last_name'] ?></a><br> -->
					<div class="row">
						<div class="col-md-6">
							<h5>Full Name:</h5> <?php echo $row['first_name']." ".$row['middle_name']." ".$row['last_name'] ?><br><br>
			...
			<div class="container  mt-1 border border-secondary mb-1"></div>
			<div class="row pt-3">
