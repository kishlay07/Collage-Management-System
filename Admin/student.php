								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <input type="text" name="state" placeholder="Delhi" class="form-control">
											    </div>
											</div>
								  		</div>
								  		<div class="row">
