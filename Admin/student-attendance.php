					...
					<div class="col-md-12 ml-2">
						<section class="border mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								<?php
								$query="select student_attendance.student_id, student_info.first_name, student_info.middle_name, student_info.last_name, student_attendance.semester, GROUP_CONCAT(student_attendance.attendance) AS attendance, GROUP_CONCAT(student_attendance.attendance_id) AS working_days from student_attendance INNER JOIN student_info ON student_attendance.student_id = student_info.roll_no";
								$run=mysqli_query($con,$query);
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
