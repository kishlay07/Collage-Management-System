        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 segment-two md-mb-30 sm-mb-30">
            <h2>CONTACT DETAILS</h2>
              <p>Address: Mussoorie, Diversion Road, Makka Wala, Uttarakhand 248009</p>
              <p>Telephones:  090846 72084</p>
              
        </div>
      </div>
    </div>
    </div>
  <p class="footer-bottom-text">CopyRights ©2021 reserved</p>
</footer>